...
def xls_to_csv(input_file:str,output_file:str,sheet_name:str):
    ...
    try:
        ...
        read_file = pd.read_excel (input_file,sheet_name=sheet_name)
    ...
    try:
        ...
        if(sheet_name in sheetNames):
            ...
            with open(output_file,'w') as textFile:
                ...
                textFile.write(dataFrame[column_name].to_markdown())
                textFile.write("\n") 
        else:
            #returning error no sheet found
            return_data["error"]="no sheet found..!"
        #storing output in dictionary
        return_data['output']="done"
        return_data['output_file']=output_file #path of saved file
        ...
        return_data['error']=e  
    return return_data  
#input_file=r'C:/Users/vivek/OneDrive/Desktop/College Project/modules/spreadsheetmanipulation/xls_file.xlsx'
#output_file=r'C:/Users/vivek/OneDrive/Desktop/College Project/modules/spreadsheetmanipulation/searchColumn.txt'
#print(search_columns(input_file,output_file,"",""))
#print(xls_to_csv("data","data","data"))