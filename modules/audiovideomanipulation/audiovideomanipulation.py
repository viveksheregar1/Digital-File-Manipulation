...
def convert(input_file:str):
    #ffmpeg is used internally by pydub to change audio format
...
def audio_to_text(input_file:str,output_file:str):
    ...
    try:
        ...
        return_data['error']=e   
    if(isconverted):
        remove("mp3_temp_audio.wav")
    return return_data 

#input_file = r"C:/Users/vivek/OneDrive/Desktop/College Project/modules/audiovideomanipulation/audio.mp3"
input_file=r"C:/Users/vivek/OneDrive/Desktop/College Project/modules/audiovideomanipulation/audio_file.mp3"
output_file=r"C:/Users/vivek/OneDrive/Desktop/College Project/modules/audiovideomanipulation/output.txt"

print(audio_to_text(input_file,output_file))