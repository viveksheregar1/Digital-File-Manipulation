...
def search_columns(input_file:str,output_file:str,sheet_name:str,column_name:str):
    ...
    try:
        ...
        return_data['error']=e  
    return return_data  
#input_file=r'C:/Users/vivek/OneDrive/Desktop/College Project/modules/spreadsheetmanipulation/empty.xlsx'
#output_file=r'C:/Users/vivek/OneDrive/Desktop/College Project/modules/spreadsheetmanipulation/output.txt'
